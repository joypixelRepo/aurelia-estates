...
// Pin scroll length and the proportion at which the wheel finishes (before fold engages)
const PIN_END = '+=500%';
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ScrollTrigger.create({
        ...
        onUpdate: (self) => {
          // Map raw progress to wheel progress so the wheel completes by WHEEL_COMPLETE_AT
          // and stays put while the fold transition plays out afterwards.
